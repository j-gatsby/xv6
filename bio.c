...
// cached copies of disk block contents. Caching disk blocks in
// memory reduces the number of disk reads and also provides a
...
// * B_DIRTY:	the buffer data has been modified and needs
